...
| NFR ID                  | Description                                                                                   |
| ----------------------- | --------------------------------------------------------------------------------------------- |
| NFR-1 (Usability)       | Commands documented in User Manual + in-shell `help`.                                       |
| NFR-2 (Reliability)     | Automated tests +`tests/COVERAGE.md` (81% model coverage).                                  |
| NFR-3 (Performance)     | Pure-Python logic with O(1) board lookups; no heavy loops beyond 9×7 grid.                   |
| NFR-4 (Maintainability) | Strict `model` vs `cli` separation, immutable pieces, documented plan.                    |
| NFR-5 (Portability)     | Python stdlib only; instructions for Windows/macOS/Linux.                                     |
| NFR-6 (Integrity)       | Honour declaration template, validation of file extensions in `cli.utils.ensure_extension`. |
